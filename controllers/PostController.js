...
PostController.AdvancesearchTicketForCit = function (req, res) {
    console.log("POST CONTROLLER AdvancesearchTicketForCit");
    var pf = new postForm(req, res, __dirname + '/../upload');
    pf.on('post', function (req, res, fields, files) {
...
PostController.createBulkAssignmentTicket = function (req, res) {
    var pf = new postForm(req, res, __dirname + '/../upload');
    pf.on('post', function (req, res, fields, files) {
        database.createBulkAssignmentTicket(fields, function (err, success, details) {
            if (err) {
                PostController.setJson(JSON.stringify({"success": false, "errorMessage": "Something went wrong"}));
            } else {
                if (success) {
...
PostController.permissionApproval = function (req, res) {
    console.log("==================-1234");
    var pf = new postForm(req, res, __dirname + '/../upload');
    pf.on('post', function (req, res, fields, files) {
        console.log('fields--' + JSON.stringify(fields));
        database.permissionApproval(fields, function (err, success, details) {
            if (err) {
                console.log("error----------",err);
                PostController.setJson(JSON.stringify({"success": false, "errorMessage": "Something went wrong"}));
            } else {
...
PostController.forwardbasis = function (req, res) {
    console.log("==================-45678");
    var pf = new postForm(req, res, __dirname + '/../upload');
    pf.on('post', function (req, res, fields, files) {
        console.log('fields--' + JSON.stringify(fields));
        database.forwardbasis(fields, function (err, success, details) {
            if (err) {
                console.log("error----------",err);
                PostController.setJson(JSON.stringify({"success": false, "errorMessage": "Something went wrong"}));
            } else {
...
PostController.createTicketEmail = function (req, res) {
    console.log("==================-45678");
    var pf = new postForm(req, res, __dirname + '/../upload');
    pf.on('post', function (req, res, fields, files) {
        console.log('fields--' + JSON.stringify(fields));
        database.createTicketEmail(fields, function (err, success, details) {
            if (err) {
                console.log("error----------",err);
                PostController.setJson(JSON.stringify({"success": false, "errorMessage": "Something went wrong"}));
            } else {
